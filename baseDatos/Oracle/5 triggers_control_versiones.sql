-- TRIGGER PARA CONTROL DE VERSIONES DE DOCUMENTOS EN ORACLE
...
CREATE OR REPLACE TRIGGER trg_documento_version_log
...
BEGIN
    IF :NEW.documento_original_id IS NOT NULL THEN
        ...
        VALUES (
            ...
            '{"nombre":"' || :NEW.documentos_nombre || '","version":' || :NEW.documentos_version || '}',
            NULL,
